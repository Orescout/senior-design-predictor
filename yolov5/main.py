...
def monitor_loop(detector, camera, communicator):
    ...
    while (True):
        ...
        print("1/3 Done (Took a photo from camera)")
        ...
        # Prep JSON to send
        message_ujson = UJSONConstructor(number_of_chainlinks, chain_direction_degrees).get_json(printit=True)
